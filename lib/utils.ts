...
export function computePipelineFlowFromApplications(applications: Application[]): PipelineFlow {
  return {
    ...
    interestPending: applications.filter((app) => app.call_status === 'Connected' && app.interested_status == null).length,
    ...
    interviewResultPending: applications.filter((app) => app.interview_scheduled && (app.interview_status == null || app.interview_status === 'Scheduled')).length,
    ...
    selectionPending: applications.filter((app) => (app.interview_status === 'Done' || app.interview_status === 'Not Attended' || app.interview_status === 'Rejected') && (app.selection_status == null || app.selection_status === 'Pending')).length,
